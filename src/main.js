...
import { Tabbar, TabbarItem, NavBar, Tab, Tabs, Swipe, SwipeItem, Lazyload, NoticeBar, Button, Uploader, Field, Divider, Cell,CellGroup, Toast, List, Card, Image, Tag, Grid, GridItem, Icon,Popup,NumberKeyboard ,Picker,Notify,Checkbox,CheckboxGroup,SubmitBar,RadioGroup,Radio} from 'vant';
